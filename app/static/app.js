...
const I18N = {
  zh: {
    ...
    modTranslation: "翻译助手",
    modTranslationDesc: "直接翻译、提炼翻译、润色翻译",
    modSettings: "系统设置",
    ...
    translationTitle: "翻译助手",
    translationLead: "输入文本并选择翻译模式，获取高质量翻译结果。",
    translationMode: "翻译模式",
    transModeDirect: "直接翻译",
    transModeRefine: "大模型提炼翻译",
    transModePolish: "大模型润色翻译",
    sourceLang: "源语言",
    targetLang: "目标语言",
    sourceText: "待翻译文本",
    btnTranslate: "翻译",
  ...
  en: {
    ...
    modTranslation: "Translation Assistant",
    modTranslationDesc: "Direct, refined, and polished translation",
    ...
    translationTitle: "Translation Assistant",
    translationLead: "Enter text and select a translation mode to get high-quality translation results.",
    translationMode: "Translation Mode",
    transModeDirect: "Direct Translation",
    transModeRefine: "LLM Refined Translation",
    transModePolish: "LLM Polished Translation",
